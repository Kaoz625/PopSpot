...
const initialGigs: Gig[] = [
  ...
  },
  {
    ...
    description: "Experienced tutor for grades 6-12. SAT prep available. Patient, encouraging approach. In-person or video sessions.",
    price: 50,
    category: "Tutoring",
  ...
  },
  {
    ...
    description: "Certified personal trainer offering 1-on-1 sessions. Weight loss, strength training, or flexibility. First session free!",
    price: 75,
    category: "Fitness",
  ...
  },
  {
    ...
    description: "Fast, affordable tech support. Laptop repairs, virus removal, data recovery, and new device setup. Same-day service available.",
    price: 65,
    category: "Tech",
  ...
  },
  {
    ...
    description: "Expert braider specializing in box braids, cornrows, twists, and protective styles. Quality hair included. Book now!",
    price: 120,
    category: "Hair Braiding",
    image: require("../../assets/images/gigs/hair-braiding.jpg"),
    sellerName: "Nia J.",
    sellerAvatar: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=100&h=100&fit=crop",
  ...
  },
  {
    ...
    description: "Thorough cleaning service for homes and apartments. Eco-friendly products. Weekly, bi-weekly, or one-time deep cleans.",
    price: 150,
  ...
  },
  {
    ...
    description: "Furniture assembly, minor repairs, painting, and odd jobs. No job too small. Reliable and affordable.",
    price: 55,
    category: "Other",
  ...
  },
  {
    ...
    description: "Caribbean-style jerk chicken with rice and peas. Made with traditional Jamaican spices. Family recipe passed down generations.",
    price: 20,
    category: "Food",
    image: require("../../assets/images/gigs/lasagna.jpg"),
    sellerName: "Keisha B.",
  ...
  },
  {
    ...
    description: "Reliable pet sitter for dogs and cats. Your pet stays at my home with 24/7 care, daily walks, and lots of love!",
    price: 40,
    category: "Services",
    image: require("../../assets/images/gigs/dog-walking.jpg"),
    sellerName: "Amanda P.",
  ...
  },
  {
    ...
    description: "Professional headshots and portrait sessions. Perfect for LinkedIn, dating profiles, or personal branding. Includes 10 edited photos.",
    price: 175,
    category: "Art",
    image: require("../../assets/images/gigs/tattoo.jpg"),
    sellerName: "Jordan C.",
  ...
  },
  {
    id: "13",
    title: "Piano Lessons",
    description: "Experienced piano teacher for all ages and skill levels. Classical, jazz, or pop. In-home lessons available.",
    price: 60,
    category: "Tutoring",
    image: require("../../assets/images/gigs/tutoring.jpg"),
    sellerName: "Claire H.",
  ...
  },
  {
    ...
    description: "Personalized yoga sessions in your home or outdoors. Vinyasa, Hatha, or Restorative. All levels welcome, equipment provided.",
    price: 80,
    category: "Fitness",
    image: require("../../assets/images/gigs/fitness.jpg"),
    sellerName: "Mia L.",
  ...
  },
  {
    ...
    description: "Quick and affordable iPhone screen replacements. All models supported. 30-minute service with 90-day warranty.",
    price: 85,
    category: "Tech",
    image: require("../../assets/images/gigs/tech.jpg"),
    sellerName: "Tyler N.",
